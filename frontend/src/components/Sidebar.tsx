                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                      {viewMode === 'user' ? (
                        <div className="py-2">
                          ...
                          <button onClick={() => { setUserSubView('graph'); onDocumentSelect?.(); }} className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-200/60 dark:hover:bg-gray-700/60 transition-colors">
                      ...
                      <div ref={listRef} className="absolute inset-0 overflow-y-auto custom-scrollbar" onDragOver={(e) => e.preventDefault()} onDrop={handleRootDrop} onClick={() => setSelectedFolderId(null)}>
                        {viewMode === 'user' ? (
                          <div className="py-2">
                            ...
                            {/* 知识图谱 */}
                            <button
                              onClick={() => { setUserSubView('graph'); onDocumentSelect?.(); }}
                              className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-200/60 dark:hover:bg-gray-700/60 transition-colors"
                            >
                              <svg className="w-4 h-4 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3" /><circle cx="4" cy="6" r="2" /><circle cx="20" cy="6" r="2" /><circle cx="4" cy="18" r="2" /><circle cx="20" cy="18" r="2" /><line x1="9.5" y1="10.5" x2="5.5" y2="7.5" /><line x1="14.5" y1="10.5" x2="18.5" y2="7.5" /><line x1="9.5" y1="13.5" x2="5.5" y2="16.5" /><line x1="14.5" y1="13.5" x2="18.5" y2="16.5" /></svg>
                              <span>知识图谱</span>
