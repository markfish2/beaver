        ...
        <div className="grid grid-cols-7 gap-1">
          {cells.map((day, i) => {
            ...
            return (
              ...
              >
                <span className={`relative w-[92%] h-[92%] rounded-[7px] flex items-center justify-center text-[10px] transition-colors ${
                  dragOverDay === day
                    ...
                    <button
                      ...
                      className={`px-2 py-1 text-xs rounded transition-colors ${
                        item.year === year && m === month
                          ? 'bg-[var(--app-link)] dark:bg-[var(--app-link)] text-white dark:text-white font-medium'
